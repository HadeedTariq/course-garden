...
const playlist_routes_1 = require("./routes/playlist/playlist.routes");
const feedback_routes_1 = require("./routes/feedback/feedback.routes");
...
app.use("/playlist", playlist_routes_1.playlisRouter);
app.use("/feedback", feedback_routes_1.feedbackRouter);
